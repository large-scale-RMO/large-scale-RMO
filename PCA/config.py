...
def parse_opt():
    ...
    parser.add_argument('--modelsave', type=int,default=10000)
    ...
    parser.add_argument('--Observe', type=int, default=1500)
    ...
    parser.add_argument('--Neumann_series', type = float, default = 1)
