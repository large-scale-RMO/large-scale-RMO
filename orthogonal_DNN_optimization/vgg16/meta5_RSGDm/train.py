...
from optimizer.RSGDM import RSGDM
...
observation_optimizer = RSGDM(opt)
...
for epoch in range(learning_epoch):
    if epoch % opt.lr_step == 0 and epoch != 0 and hand_e_lr >0.0001:
