...
from MatrixLSTM0.MatrixLSTM import MatrixLSTM
from MatrixLSTM_lr0.MatrixLSTM import MatrixLSTM_lr


class LSTM_Optimizee_Model0(nn.Module):    
    def __init__(self,opt,input_size, output_size, batchsize_data,batchsize_para):
        super(LSTM_Optimizee_Model0,self).__init__()
