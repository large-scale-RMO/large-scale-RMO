...
def parse_opt():
    ...
    parser.add_argument('--epoch', type= int, default = 18000)
    ...
    parser.add_argument('--hand_s_lr', type=float, default= 0.0001)
    parser.add_argument('--momentum_gama_e', type=float, default=0.9)
    parser.add_argument('--momentum_lr_e', type=float, default= 0.01)
    parser.add_argument('--momentum_gama_s', type=float, default=0.9)
    parser.add_argument('--momentum_lr_s', type=float, default= 0.01)
    parser.add_argument('--rmsprop_beta', type=float, default = 0.99)
