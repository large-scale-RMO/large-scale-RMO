...
def parse_opt():
    ...
    parser.add_argument('--warm_epoch', type = int, default=2000)
    parser.add_argument('--warm_start', type = float, default= 0.1)
    ...
    parser.add_argument('--s_lr', type=float, default= 1)
